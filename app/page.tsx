...
export const metadata = {
  title: 'MaydAI - Plateforme de Conformité AI Act | Audit IA Automatisé & Gestion Centralisée',
  description: 'MaydAI est la plateforme SaaS qui simplifie la mise en conformité avec l\'AI Act européen. Audit automatisé, classification des risques, génération de documentation et accompagnement expert pour développer des systèmes d\'IA en toute confiance.',
...
export default function HomePage() {
  ...
  const organizationStructuredData = {
    ...
    "description": "MaydAI est la plateforme SaaS qui simplifie la mise en conformité avec l'AI Act européen. Grâce à notre audit automatisé et notre gestion centralisée, nous permettons aux entreprises de développer et déployer des systèmes d'IA en toute confiance.",
    "foundingDate": "2025",
  ...
  const softwareApplicationStructuredData = {
    ...
    "description": "Plateforme SaaS qui simplifie la mise en conformité avec l'AI Act européen. Audit automatisé, gestion centralisée et accompagnement expert pour développer des systèmes d'IA en toute confiance.",
    "url": "https://www.maydai.io",
