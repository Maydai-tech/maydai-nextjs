...
describe('questionnaire-v3-short-path-ux', () => {
  ...
  it('retourne un segment avec titre et accroche (transparence)', () => {
    const s = getV3ShortPathSegmentForQuestion('V3_SHORT_TRANSPARENCE')
  ...
  it('progression court : plafond inférieur à 100 si pas dernière question', () => {
    const p = getV3ShortPathProgressPercent('V3_SHORT_USAGE', false)
