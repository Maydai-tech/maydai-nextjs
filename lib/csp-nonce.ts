...
export function createCSPHeader(nonce: string): string {
  ...
  return [
    ...
    "connect-src 'self' https://*.supabase.co https://www.google.com https://region1.google-analytics.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://www.googletagmanager.com https://cookieyes.com https://cdn-cookieyes.com https://app.cookieyes.com https://log.cookieyes.com https://api.cookieyes.com https://widget.cookieyes.com https://api.hsforms.com https://forms.hubspot.com https://forms-eu1.hsforms.com https://api.hubspot.com https://api.hubapi.com",
    // Polices
