...
// Données de démonstration pour différents types de cas d'usage
const demoData = [
  {
    usecase_id: '5d996313-8484-4b15-a571-4210fcb1235f', // Détecteur de fraude
    introduction: 'Ce système de détection de fraude utilise des algorithmes d\'IA pour analyser les transactions en temps réel.',
  ...
  {
    usecase_id: '7cedcfb1-77b7-416a-b992-faadcc4edff8', // Tri candidature
  ...
  {
    usecase_id: 'fe8d68cd-6727-4e6c-95ac-9fe10d7d2379', // Assistant planificateur
  ...
  {
    usecase_id: '20783d2a-0b95-41d8-af78-281acc368eab', // Assistant déduplication
  ...
  {
    usecase_id: '2ae1546d-e9ca-4d1c-beee-8b4896595139', // Scoring Leads
