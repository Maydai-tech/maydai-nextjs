...
-- companies
CREATE POLICY "companies_delete_owner" ON public.companies FOR DELETE TO authenticated USING (is_company_owner(auth.uid(), id) OR is_super_admin(auth.uid()));
CREATE POLICY "companies_insert_authenticated" ON public.companies FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "companies_select_admin" ON public.companies FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "companies_select_member" ON public.companies FOR SELECT TO authenticated USING (user_belongs_to_company(auth.uid(), id));
CREATE POLICY "companies_update_admin" ON public.companies FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "companies_update_member" ON public.companies FOR UPDATE TO authenticated USING (user_belongs_to_company(auth.uid(), id));

-- compl_ai_benchmarks
CREATE POLICY "compl_ai_benchmarks_delete_admin" ON public.compl_ai_benchmarks FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "compl_ai_benchmarks_insert_admin" ON public.compl_ai_benchmarks FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
...
CREATE POLICY "compl_ai_benchmarks_update_admin" ON public.compl_ai_benchmarks FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- compl_ai_evaluations
CREATE POLICY "compl_ai_evaluations_delete_admin" ON public.compl_ai_evaluations FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "compl_ai_evaluations_insert_admin" ON public.compl_ai_evaluations FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
...
CREATE POLICY "compl_ai_evaluations_update_admin" ON public.compl_ai_evaluations FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- compl_ai_models
CREATE POLICY "compl_ai_models_delete_admin" ON public.compl_ai_models FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "compl_ai_models_insert_admin" ON public.compl_ai_models FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
CREATE POLICY "compl_ai_models_select_authenticated" ON public.compl_ai_models FOR SELECT TO authenticated USING (true);
CREATE POLICY "compl_ai_models_update_admin" ON public.compl_ai_models FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- compl_ai_principles
CREATE POLICY "compl_ai_principles_delete_admin" ON public.compl_ai_principles FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "compl_ai_principles_insert_admin" ON public.compl_ai_principles FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
...
CREATE POLICY "compl_ai_principles_update_admin" ON public.compl_ai_principles FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- compl_ai_sync_logs
CREATE POLICY "compl_ai_sync_logs_select_admin" ON public.compl_ai_sync_logs FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- contact_requests
CREATE POLICY "Users can insert their own contact requests" ON public.contact_requests FOR INSERT TO public WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can view their own contact requests" ON public.contact_requests FOR SELECT TO public USING (auth.uid() = user_id);

-- dossier_documents
CREATE POLICY "dossier_documents_insert" ON public.dossier_documents FOR INSERT TO public WITH CHECK (EXISTS ( SELECT 1 FROM dossiers d JOIN user_companies uc ON uc.company_id = d.company_id WHERE d.id = dossier_documents.dossier_id AND uc.user_id = auth.uid()));
CREATE POLICY "dossier_documents_select" ON public.dossier_documents FOR SELECT TO public USING (EXISTS ( SELECT 1 FROM dossiers d JOIN user_companies uc ON uc.company_id = d.company_id WHERE d.id = dossier_documents.dossier_id AND uc.user_id = auth.uid()));
CREATE POLICY "dossier_documents_update" ON public.dossier_documents FOR UPDATE TO public USING (EXISTS ( SELECT 1 FROM dossiers d JOIN user_companies uc ON uc.company_id = d.company_id WHERE d.id = dossier_documents.dossier_id AND uc.user_id = auth.uid())) WITH CHECK (EXISTS ( SELECT 1 FROM dossiers d JOIN user_companies uc ON uc.company_id = d.company_id WHERE d.id = dossier_documents.dossier_id AND uc.user_id = auth.uid()));

-- dossiers
CREATE POLICY "dossiers_insert" ON public.dossiers FOR INSERT TO public WITH CHECK (EXISTS ( SELECT 1 FROM user_companies uc WHERE uc.company_id = dossiers.company_id AND uc.user_id = auth.uid()));
CREATE POLICY "dossiers_select" ON public.dossiers FOR SELECT TO authenticated USING (user_belongs_to_company(auth.uid(), company_id));
CREATE POLICY "dossiers_update" ON public.dossiers FOR UPDATE TO authenticated USING (user_belongs_to_company(auth.uid(), company_id));

-- model_providers
CREATE POLICY "model_providers_delete_admin" ON public.model_providers FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "model_providers_insert_admin" ON public.model_providers FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
CREATE POLICY "model_providers_select_authenticated" ON public.model_providers FOR SELECT TO authenticated USING (true);
CREATE POLICY "model_providers_update_admin" ON public.model_providers FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- plans
CREATE POLICY "plans_delete_admin" ON public.plans FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "plans_insert_admin" ON public.plans FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
...
CREATE POLICY "plans_update_admin" ON public.plans FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- profiles
CREATE POLICY "profiles_delete_super_admin" ON public.profiles FOR DELETE TO authenticated USING (is_super_admin(auth.uid()));
CREATE POLICY "profiles_insert_own" ON public.profiles FOR INSERT TO authenticated WITH CHECK (auth.uid() = id);
CREATE POLICY "profiles_select_admin" ON public.profiles FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "profiles_select_own" ON public.profiles FOR SELECT TO authenticated USING (auth.uid() = id);
CREATE POLICY "profiles_update_admin" ON public.profiles FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "profiles_update_own" ON public.profiles FOR UPDATE TO authenticated USING (auth.uid() = id) WITH CHECK (auth.uid() = id);

-- services
CREATE POLICY "services_delete_admin" ON public.services FOR DELETE TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "services_insert_admin" ON public.services FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM profiles p WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['admin'::text, 'super_admin'::text])))));
CREATE POLICY "services_select_authenticated" ON public.services FOR SELECT TO authenticated USING (true);
CREATE POLICY "services_update_admin" ON public.services FOR UPDATE TO authenticated USING (is_admin_or_super_admin(auth.uid()));

-- subscriptions
CREATE POLICY "subscriptions_select_admin" ON public.subscriptions FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "subscriptions_select_own" ON public.subscriptions FOR SELECT TO authenticated USING (user_id = auth.uid());

-- usecase_history
CREATE POLICY "Users can insert history for accessible usecases" ON public.usecase_history FOR INSERT TO public WITH CHECK (((auth.uid() IS NOT NULL) AND (user_id = auth.uid()) AND (usecase_id IN ( SELECT u.id FROM usecases u WHERE (u.company_id IN ( SELECT uc.company_id FROM user_companies uc WHERE (uc.user_id = auth.uid())))))) OR ((auth.uid() IS NULL) AND (user_id IS NOT NULL) AND (usecase_id IN ( SELECT u.id FROM usecases u WHERE (u.company_id IN ( SELECT uc.company_id FROM user_companies uc WHERE (uc.user_id = usecase_history.user_id)))))));
CREATE POLICY "Users can view history for accessible usecases" ON public.usecase_history FOR SELECT TO public USING (usecase_id IN ( SELECT u.id FROM usecases u WHERE (u.company_id IN ( SELECT user_companies.company_id FROM user_companies WHERE (user_companies.user_id = auth.uid())))));

-- usecase_nextsteps
CREATE POLICY "usecase_nextsteps_insert_via_usecase" ON public.usecase_nextsteps FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1 FROM usecases u JOIN user_companies uc ON uc.company_id = u.company_id WHERE u.id = usecase_nextsteps.usecase_id AND uc.user_id = auth.uid())) OR (EXISTS ( SELECT 1 FROM user_usecases uu WHERE uu.usecase_id = usecase_nextsteps.usecase_id AND uu.user_id = auth.uid())) OR is_admin_or_super_admin(auth.uid()));
CREATE POLICY "usecase_nextsteps_select_admin" ON public.usecase_nextsteps FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "usecase_nextsteps_select_via_usecase" ON public.usecase_nextsteps FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1 FROM usecases u JOIN user_companies uc ON uc.company_id = u.company_id WHERE u.id = usecase_nextsteps.usecase_id AND uc.user_id = auth.uid())) OR (EXISTS ( SELECT 1 FROM user_usecases uu WHERE uu.usecase_id = usecase_nextsteps.usecase_id AND uu.user_id = auth.uid())));
CREATE POLICY "usecase_nextsteps_update_via_usecase" ON public.usecase_nextsteps FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1 FROM usecases u JOIN user_companies uc ON uc.company_id = u.company_id WHERE u.id = usecase_nextsteps.usecase_id AND uc.user_id = auth.uid())) OR (EXISTS ( SELECT 1 FROM user_usecases uu WHERE uu.usecase_id = usecase_nextsteps.usecase_id AND uu.user_id = auth.uid())) OR is_admin_or_super_admin(auth.uid()));

-- usecase_responses
CREATE POLICY "usecase_responses_delete_via_usecase" ON public.usecase_responses FOR DELETE TO authenticated USING ((EXISTS ( SELECT 1 FROM usecases u JOIN user_companies uc ON uc.company_id = u.company_id WHERE u.id = usecase_responses.usecase_id AND uc.user_id = auth.uid())) OR (EXISTS ( SELECT 1 FROM user_usecases uu WHERE uu.usecase_id = usecase_responses.usecase_id AND uu.user_id = auth.uid())));
...
CREATE POLICY "usecase_responses_select_admin" ON public.usecase_responses FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
...
-- usecases
CREATE POLICY "usecases_delete_company_member" ON public.usecases FOR DELETE TO authenticated USING (user_belongs_to_company(auth.uid(), company_id));
CREATE POLICY "usecases_insert_company_member" ON public.usecases FOR INSERT TO authenticated WITH CHECK (user_belongs_to_company(auth.uid(), company_id));
CREATE POLICY "usecases_select_admin" ON public.usecases FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "usecases_select_company" ON public.usecases FOR SELECT TO authenticated USING (user_belongs_to_company(auth.uid(), company_id));
CREATE POLICY "usecases_select_direct_access" ON public.usecases FOR SELECT TO authenticated USING (user_has_usecase_access(auth.uid(), id));
CREATE POLICY "usecases_update_company_member" ON public.usecases FOR UPDATE TO authenticated USING (user_belongs_to_company(auth.uid(), company_id));
CREATE POLICY "usecases_update_direct_access" ON public.usecases FOR UPDATE TO authenticated USING (user_has_usecase_access(auth.uid(), id));

-- user_companies
CREATE POLICY "user_companies_delete_owner" ON public.user_companies FOR DELETE TO authenticated USING (is_company_owner(auth.uid(), company_id));
CREATE POLICY "user_companies_delete_self" ON public.user_companies FOR DELETE TO authenticated USING ((user_id = auth.uid()) AND (role <> 'owner'::text));
CREATE POLICY "user_companies_insert_first_owner" ON public.user_companies FOR INSERT TO authenticated WITH CHECK ((user_id = auth.uid()) AND (role = 'owner'::text) AND (NOT (EXISTS ( SELECT 1 FROM user_companies uc WHERE ((uc.company_id = user_companies.company_id) AND (uc.role = 'owner'::text))))));
CREATE POLICY "user_companies_insert_owner" ON public.user_companies FOR INSERT TO authenticated WITH CHECK (is_company_owner(auth.uid(), company_id));
CREATE POLICY "user_companies_select_admin" ON public.user_companies FOR SELECT TO authenticated USING (is_admin_or_super_admin(auth.uid()));
CREATE POLICY "user_companies_select_own" ON public.user_companies FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "user_companies_update_owner" ON public.user_companies FOR UPDATE TO authenticated USING (is_company_owner(auth.uid(), company_id));

-- user_profiles
CREATE POLICY "user_profiles_delete_involved" ON public.user_profiles FOR DELETE TO authenticated USING ((inviter_user_id = auth.uid()) OR (invited_user_id = auth.uid()));
CREATE POLICY "user_profiles_insert_inviter" ON public.user_profiles FOR INSERT TO authenticated WITH CHECK (inviter_user_id = auth.uid());
CREATE POLICY "user_profiles_select_involved" ON public.user_profiles FOR SELECT TO authenticated USING ((inviter_user_id = auth.uid()) OR (invited_user_id = auth.uid()));
CREATE POLICY "user_profiles_update_inviter" ON public.user_profiles FOR UPDATE TO authenticated USING (inviter_user_id = auth.uid());

-- user_usecases
CREATE POLICY "user_usecases_delete_company_member" ON public.user_usecases FOR DELETE TO authenticated USING (user_has_company_usecase_access(auth.uid(), usecase_id));
CREATE POLICY "user_usecases_insert_company_member" ON public.user_usecases FOR INSERT TO authenticated WITH CHECK (user_has_company_usecase_access(auth.uid(), usecase_id));
CREATE POLICY "user_usecases_select_company_member" ON public.user_usecases FOR SELECT TO authenticated USING (user_has_company_usecase_access(auth.uid(), usecase_id));
CREATE POLICY "user_usecases_select_own" ON public.user_usecases FOR SELECT TO authenticated USING (user_id = auth.uid());
