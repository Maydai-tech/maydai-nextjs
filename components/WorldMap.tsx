...
const WorldMapComponent: React.FC<WorldMapProps> = ({ deploymentCountries, countryUseCaseCount = {}, className = "", showUseCaseCount = true }) => {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm overflow-hidden ${className}`} style={{ height: '292px' }}>
      <div className="p-6 relative h-full">
        <div className="relative h-full">
          {/* Titre en haut à gauche */}
          <div className="absolute top-2 left-2 z-10 bg-white px-2 py-1 rounded-br-lg">
          ...
          {/* Légende en bas au milieu */}
          <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 bg-white px-2 py-1 rounded-t-lg whitespace-nowrap">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-[#0080A3] rounded-sm flex-shrink-0"></div>
