...
export default function BillingToggle({ billingCycle, onToggle }: BillingToggleProps) {
  return (
    <div className="relative flex items-center justify-center space-x-4 p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-gray-100">
      ...
      <span
        className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-[160%] whitespace-nowrap inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border transition-all duration-200
          z-10
          ${billingCycle === 'yearly'
