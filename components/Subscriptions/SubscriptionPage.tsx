...
import { useStripe } from '@/app/(saas)/abonnement/hooks/useStripe'
import { useSubscription } from '@/app/(saas)/abonnement/hooks/useSubscription'
import { usePlans } from '@/app/(saas)/abonnement/hooks/usePlans'
...
import { useUpdateSubscription } from '@/app/(saas)/abonnement/hooks/useUpdateSubscription'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="w-full mx-auto px-4 py-6">
        ...
        <div className="mb-12">
          ...
          {/* Bloc Audit personnalisé */}
          <div className="mt-12 mb-12">
            <div className="bg-gradient-to-br from-[#0080A3] to-[#006280] rounded-xl p-8 md:p-12 shadow-lg">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Audit personnalisé
                </h2>
                <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                  Besoin d'un accompagnement sur mesure pour la conformité IA Act de votre organisation ?
                  Notre équipe d'experts est à votre disposition pour un audit personnalisé et un devis adapté à vos besoins.
                </p>
                <button
                  onClick={() => {
                    router.push('/contact')
                  }}
                  className="bg-white text-[#0080A3] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-all duration-200 shadow-md hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  Contacter MaydAI
                </button>
                <p className="text-white/80 text-sm mt-6">
                  Devis sur mesure • Réponse sous 48h • Sans engagement
                </p>
              </div>
            </div>
          </div>
