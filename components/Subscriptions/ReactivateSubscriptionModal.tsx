        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${
              success ? 'bg-green-100' : loading ? 'bg-blue-100' : 'bg-green-100'
            }`}>
              {success ? (
            ...
            <h2 className="text-lg font-semibold text-gray-900">
              {success
                ...
                : loading
                  ...
                  : 'Réactiver votre abonnement MaydAI ?'
              }
            </h2>
          </div>
          <button
          ...
          {success ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-600" />
                <div>
                  <p className="text-green-800 font-medium">Réactivation réussie !</p>
                  <p className="text-green-700 text-sm mt-1">
                    Votre abonnement <span className="font-semibold">{planName}</span> est maintenant actif.
                  </p>
                </div>
              </div>
            </div>
            ...
            <>
              <div className="mb-6">
                <p className="text-gray-700 mb-4">
                  Votre abonnement <span className="font-semibold">{planName}</span> sera réactivé et la facturation reprendra le{' '}
                  <span className="font-semibold text-green-600">{nextBillingDate}</span>.
                </p>
                ...
                {loading && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-3">
                      <Loader2 className="h-5 w-5 text-blue-600 animate-spin" />
                      <div>
                        <p className="text-blue-800 font-medium">Réactivation en cours...</p>
              ...
              <div className="mb-6">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    Je comprends et souhaite réactiver mon abonnement
                  </span>
                </label>
              </div>
            </>
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3">
            ...
            {success ? (
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {loading ? (
                  <>
